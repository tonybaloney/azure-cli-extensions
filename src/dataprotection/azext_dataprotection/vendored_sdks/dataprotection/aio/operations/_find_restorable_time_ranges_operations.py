...
class FindRestorableTimeRangesOperations:
    """FindRestorableTimeRangesOperations async operations.
    ...
    async def post(
        ...
        **kwargs
        ...
        return deserialized
    post.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstances}/findRestorableTimeRanges'}  # type: ignore
