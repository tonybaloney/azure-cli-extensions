...
class DataProtectionClient(DataProtectionClientOperationsMixin):
    ...
    :vartype operations: data_protection_client.aio.operations.Operations
    ...
    :vartype recovery_point: data_protection_client.aio.operations.RecoveryPointOperations
    ...
    :vartype find_restorable_time_ranges: data_protection_client.aio.operations.FindRestorableTimeRangesOperations
    :ivar job: JobOperations operations
    :vartype job: data_protection_client.aio.operations.JobOperations
