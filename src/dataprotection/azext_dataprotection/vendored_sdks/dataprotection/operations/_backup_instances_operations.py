...
class BackupInstancesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.BackupInstanceResourceList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~data_protection_client.models.BackupInstanceResourceList]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.BackupInstanceResource"
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "models.BackupInstanceResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.BackupInstanceResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BackupInstanceResource"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.BackupInstanceResource"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~data_protection_client.models.BackupInstanceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _adhoc_backup_initial(
        ...
        resource_group_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "models.TriggerBackupRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationJobExtendedInfo"]
    ...
    def begin_adhoc_backup(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.OperationJobExtendedInfo"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~data_protection_client.models.OperationJobExtendedInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def _validate_for_backup_initial(
        ...
        vault_name,  # type: str
        resource_group_name,  # type: str
        parameters,  # type: "models.ValidateForBackupRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationJobExtendedInfo"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationJobExtendedInfo"]]
    ...
    def _trigger_rehydrate_initial(
        ...
        vault_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "models.AzureBackupRehydrationRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
    ...
    def _trigger_restore_initial(
        ...
        resource_group_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "models.AzureBackupRestoreRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationJobExtendedInfo"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationJobExtendedInfo"]]
    ...
    def _validate_restore_initial(
        ...
        resource_group_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "models.ValidateRestoreRequestObject"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationJobExtendedInfo"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationJobExtendedInfo"]]
        ...
        # Construct URL
        url = self._validate_restore_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'vaultName': self._serialize.url("vault_name", vault_name, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        ...
        return deserialized
    _validate_restore_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/validateRestore'}  # type: ignore

    def begin_validate_restore(
        self,
        vault_name,  # type: str
        resource_group_name,  # type: str
        backup_instance_name,  # type: str
        ...
        **kwargs  # type: Any
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_validate_restore.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/validateRestore'}  # type: ignore
